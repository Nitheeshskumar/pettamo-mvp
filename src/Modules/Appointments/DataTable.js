...
const handleChange=e=>{
  ...
  <input className="form-check-input" type="radio" name="isMedical" id="inlineCheck1" value="1" checked={filter.includes('1')} onChange={handleChange}/>
  <label className="form-check-label" htmlFor="inlineCheck1">To Do</label>
</div>
<div className="form-check form-check-inline">
  <input className="form-check-input" type="radio" name="isMedical" id="inlineCheck2" value="2" checked={filter.includes('2')} onChange={handleChange}/>
...
{/* <div className="form-check form-check-inline">
  ...
  <label className="form-check-label" htmlFor="inlineCheck3">Done</label>
            ...
            <table className="table is-hoverable " style={{whiteSpace:'nowrap',overflow:'auto'}}>
                <thead>
                  {filter.isMedical==='1'?  <tr className="has-background-link">
                ...
                {props.appointMentsList.map(el=> filter.isMedical==='1'? <tr>
